...
Transform.prototype.Cursors = {
   ...
   * @api stable
   */
 Transform.prototype.setMap = function(map) {
    if (this.getMap()) {
   ...
   * @api stable
   */
Transform.prototype.setActive = function(b) {
    this.select(null);
  ...
  */
  Transform.prototype.setDefaultStyle = function() {
    // Style
   ...
   * @api stable
   */
Transform.prototype.setStyle = function(style, olstyle) {
    if (!olstyle) return;
   ...
   * @private
   */
Transform.prototype.getFeatureAtPixel_ = function(pixel) {
    var self = this;
   ...
   */
Transform.prototype.getGeometryRotateToZero_ = function(f, clone) {
  ...
  */
Transform.prototype.drawSketch_ = function(center) {
    var i, f, geom;
  ...
  */
Transform.prototype.select = function(feature, add) {
    if (!feature) {
  ...
  */
Transform.prototype.setSelection = function(features) {
    this.selection_.clear();
   ...
   * @private
   */
Transform.prototype.watchFeatures_ = function() {
   ...
   * @private
   */
Transform.prototype.handleDownEvent_ = function(evt) {
   ...
   */
Transform.prototype.getFeatures = function() {
   ...
   */
Transform.prototype.getCenter = function() {
   ...
   */
  Transform.prototype.setCenter = function(c) {
   ...
   * @private
   */
 Transform.prototype.handleDragEvent_ = function(evt) {
   ...
   * @private
   */
  Transform.prototype.handleMoveEvent_ = function(evt) {
    if (!this._handleEvent(evt, this.features_)) return;
   ...
   */
  Transform.prototype.handleUpEvent_ = function(evt) {
