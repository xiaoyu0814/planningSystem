...
export default {
  ...
  methods: {
    init() {
      ...
      this.SlopeAspectTool = new SlopeAspectTool(
        viewer,
        viewer.terrainProvider
      );
    },
    onCancel() {
      this.$store.state.slopeDirection_show = false;
    },
    draw() {
      this.SlopeAspectTool.setEnable(true);
    },
    remove() {
      this.SlopeAspectTool.setEnable(false);
    },
  },
};
</script>
