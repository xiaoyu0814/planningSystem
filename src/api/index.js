...
service.interceptors.request.use(
    (config) => {
        ...
        // let token = "hguEpFyjxgE0LpNs5YqvabFkIOGM5Fp5"
...
export const req = {
    ...
    post(url, param = {}, header) {
        ...
        return new Promise((resolve, reject) => {
            let aa = {
                ...
                url,
                data: param,
                header: header ? { "Content-Type": "text/plain" } : { "Content-Type": "application/json;charset=UTF-8" },
            }
            console.log(aa)
            service(aa)
                .then((res) => {
    ...
    postPbf(url, param = {}, header = { "Content-Type": "application/x-www-form-urlencoded" }) {
        return new Promise((resolve, reject) => {
            service({
                method: "post",
                url,
